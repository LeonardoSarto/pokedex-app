...
import '../text-style/pokemon-solid-style.dart';
...
class DarkThemeData {
  ThemeData get themeData {
    ...
    DialogTheme dialogTheme = DialogTheme(
        titleTextStyle: PokemonSolidStyle(fontSize: 18, color: Colors.white));
    TextButtonThemeData textButtonTheme = TextButtonThemeData(
        style: ButtonStyle(
            textStyle:
            MaterialStatePropertyAll(PokemonSolidStyle(fontSize: 18)),
    ...
    AppBarTheme appBarTheme = AppBarTheme(
      ...
      titleTextStyle: PokemonSolidStyle(color: Colors.white),
    );
